# [Implement stack using Linkedlist](https://takeuforward.org/practice/dsa/implement-stack-using-linkedlist?category=implementation&source=strivers-a2z-dsa-sheet&tab=problem)
