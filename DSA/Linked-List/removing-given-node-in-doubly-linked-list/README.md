# [Removing given node in Doubly Linked List](https://takeuforward.org/plus/dsa/problems/removing-given-node-in-dll?subject=dsa&approach=optimal&tab=submissions)
